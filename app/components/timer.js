  ...
  return (
    <div className="flex justify-center items-center flex-col w-11/12 sm:w-10/12 mx-auto pt-5 pb-5 rounded">
        ...
        {options.map((option, index) => {
          return (
            <h1
              ...
              } p-1 rounded hover:bg-gray-100 cursor-pointer transition-all`}
      ...
      <div className="flex items-center gap-2">
        <button
          className=" px-16 py-2 text-2xl rounded-md bg-white text-gray-500 hover:bg-gray-100 uppercase font-semibold"
          onClick={startTimer}
        >
          {ticking ? "Stop" : "Start"}
        </button>
