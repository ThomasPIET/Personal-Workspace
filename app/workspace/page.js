  ...
  return (
    <section className="flex items-center h-screen bg-white dark:bg-gray-900 ">
      ...
      <Modal
        ...
        style={{ width: "auto", height: "auto", marginTop: "105px", marginLeft: "580px"}}

      >
        <Modal.Body>
          {/* header du modal  */}
          <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 bottom-5">
          ...
          <div className="p-4 md:p-5 bottom">
            ...
            <ul className="my-4 space-y-3">
              <li>
                ...
                >
                  <span className="flex-1 ms-3 whitespace-nowrap">outil 1</span>
                </a>
              </li>
              <li>
                <a
                  ...
                  className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white"
                >
                  <span className="flex-1 ms-3 whitespace-nowrap">outil 2</span>
                </a>
              </li>
              <li>
                <a
